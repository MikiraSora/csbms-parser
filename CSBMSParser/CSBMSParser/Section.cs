 ...
 */
    public class Section
    {
            ...
            foreach (string line in lines)
            {
                ...
                switch (channel)
                {
                    ...
                    case BPM_CHANGE:
                        ...
                        {
                            bpmchange.Add(pos, (double)(data / 36) * 16 + (data % 36));
                        });
                        break;
                    // POORアニメーション
                    case POOR_PLAY:
        ...
        private Dictionary<double, double> bpmchange = new Dictionary<double, double>();
        private Dictionary<double, double> stop = new Dictionary<double, double>();
        private Dictionary<double, double> scroll = new Dictionary<double, double>();
        ...
        private Dictionary<double, TimeLineCache> tlcache;

        /**
         * SectionモデルからTimeLineモデルを作成し、BMSModelに登録する
         */
        public void makeTimeLines(int[] wavmap, int[] bgamap, Dictionary<double, TimeLineCache> tlcache, List<LongNote>[] lnlist, LongNote[] startln)
        {
